...
document.querySelector("#play").addEventListener("click", function() {
	...
	vol.innerHTML = document.querySelector("#slider").value;
});
...
document.querySelector("#slower").addEventListener("click", function() {
	video.playbackRate = 0.9 * video.playbackRate;
 	console.log("Slow Speed: " + video.playbackRate);
});

document.querySelector("#faster").addEventListener("click", function() {
	video.playbackRate = 1/0.9 * video.playbackRate;
 	console.log("Fast Speed: " + video.playbackRate);
});

document.querySelector("#skip").addEventListener("click", function() {
	video.currentTime += 10;
 	console.log("Time on video: " + video.currentTime);
